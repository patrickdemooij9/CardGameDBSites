...
{
    internal class ImageSharpImageSourceFix<TPixel> : ImageSource where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        protected override IImageSource FromStreamImpl(string name, Func<Stream> imageStream, int? quality = 75)
        {
            using (var stream = imageStream.Invoke())
            {
                ...
                return new ImageSharpImageSourceImpl<TPixel>(name, image, (int)quality, false);
            }
        }
